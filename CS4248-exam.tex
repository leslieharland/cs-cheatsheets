...
%\\
%V is the number of distinct words of the whole text\\
%Z is the number of distinct words in the corpus\\
%$C(w, c_{i})$ = number of times w occurs in the corpus\\
...
\\
\includegraphics[height=4.5cm]{images/w14}\\
\includegraphics[height=5cm]{images/w12_1}\\
...
\includegraphics[height=7cm]{images/w.png}
\\
\includegraphics[height=2cm]{images/w1.png}
\subsubsection*{Witten Bell}
\\
If C^{*}($w_{x}w_{i}$) $>$ 0, $C(w_{x})$ $\times \frac{C(w_{x}w_{i})}{C(w_{x}) + T(w_{x})}$
\\
...
\\
V is the number of distinct words of the whole text\\
T is the number of distinct words in the corpus\\
Z = V - T \\
$C(w, c_{i})$ = number of times w occurs in the corpus\\
\end{multicols*}
\end{document}
